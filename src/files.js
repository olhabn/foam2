...
//  { name: "foam/mlang/order/ComparatorJava", flags: ['java'] },
  ...
  { name: "foam/u2/svg/graph/PredeterminedGridPlacementPlan", flags: ['web'] },
  { name: "foam/u2/svg/graph/IdPropertyPlacementPlanDecorator", flags: ['web'] },
  ...
  { name: "foam/comics/v2/UserSpecificCannedQuery" },
